    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-slate-50/50 p-6">
            <div className="absolute top-8 left-8">
                <Button variant="ghost" asChild className="rounded-full font-black uppercase tracking-widest text-[10px] text-slate-400 hover:text-primary transition-colors">
                    <Link to="/">
            ...
            <div className="w-full max-w-md space-y-12 animate-fade-in">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">Sign in to your LaborGuard account</p>
                </div>
                ...
                <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/50">
                    ...
                    <Button 
                        variant="ghost"
                        onClick={() => window.location.href = `${import.meta.env.VITE_AUTH_SERVICE_URL}/api/auth/google`} 
                        className="w-full h-14 rounded-2xl border-2 border-slate-100 font-black uppercase tracking-widest text-[10px] text-slate-600 hover:bg-slate-50"
                    >
